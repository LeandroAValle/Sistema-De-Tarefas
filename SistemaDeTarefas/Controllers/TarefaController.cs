...
namespace SistemaDeTarefas.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<TarefaModel>> Cadastrar([FromBody] TarefaModel usuarioModel)
        {
            TarefaModel tarefa = await _tarefaRepositorio.Adicionar(usuarioModel);
